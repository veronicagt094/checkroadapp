...
export default function ConsultarConductor() {
  ...
  async function consultarConductor(e) {
    e.preventDefault();
    Router.push({
      pathname: "./Conductor/infoConductor",
      query: { documento: numDoc.numDocumento },
    });
  }
      ...
      <div className="h-96 w-3/4 place-items-center px-24">
        ...
        <form className="shadow-md rounded-xl bg-blanco grid grid-col-1 py-20 mx-48">
          ...
          <div className="flex py-12 mx-32">
            ...
            <div className="text-center">
              <Boton onClick={consultarConductor} text="BUSCAR"></Boton>
            </div>
          </div>
        </form>
        <div className="mt-48">
